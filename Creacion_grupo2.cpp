    ...
    void modificar(){
        ...
        cout << "\n\t\t\tEntrando al menu --MODIFICAR--" << endl;
            ...
            if(!baseDatos){
                ...
                baseDatos>>documentoIdentificacion>>nombre>>edad>>correo>>telefono>>direccion>>estudios>>puesto>>sueldoh>>horastr>>horasextr;
                while (!baseDatos.eof()){
            ...
            else
            {
                ...
                while(!baseDatos.eof())
                {
                    ...
                    cout<<"\n\t\tSueldo por hora: "<< sueldoh;
                     ...
                     baseDatos>>documentoIdentificacion>>nombre>>edad>>correo>>telefono>>direccion>>estudios>>puesto>>sueldoh>>horastr>>horasextr>>sueldonet>>nomi;
                }
                if(total==0){
